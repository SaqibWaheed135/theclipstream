...
//           alert(`Your co-host request has been approved!
// Use these details in OBS Studio to stream:
...
//           style={{ gridTemplateColumns: stream.streams.length === 1 ? '1fr' : '1fr 1fr' }}
//         >
//           {stream.streams.map((s, index) => (
