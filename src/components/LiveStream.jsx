...
import { Radio, Users, Eye, Clock, Search, Filter } from 'lucide-react';
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="bg-red-600 hover:bg-red-700 px-6 py-3 rounded-lg font-semibold flex items-center gap-2 transition-colors"
            >
          ...
          <div className="flex gap-4 flex-wrap">
            <div className="flex-1 min-w-[300px] relative">
              ...
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-lg pl-10 pr-4 py-3 focus:outline-none focus:border-red-500"
              />
            </div>
            <div className="flex gap-2">
              <button
                ...
                className={`px-4 py-3 rounded-lg font-medium transition-colors ${
                  filter === 'all' ? 'bg-red-600' : 'bg-gray-800 hover:bg-gray-700'
                }`}
              >
                All
              </button>
              <button
                ...
                className={`px-4 py-3 rounded-lg font-medium transition-colors ${
                  filter === 'popular' ? 'bg-red-600' : 'bg-gray-800 hover:bg-gray-700'
                }`}
              >
                Popular
              </button>
              <button
                ...
                className={`px-4 py-3 rounded-lg font-medium transition-colors ${
                  filter === 'new' ? 'bg-red-600' : 'bg-gray-800 hover:bg-gray-700'
                }`}
              >
                New
              </button>
            ...
            >
              ...
              <div className="relative bg-gray-900 aspect-video">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <Radio className="w-16 h-16 text-gray-700 mx-auto mb-2" />
                    <p className="text-gray-600 text-sm">Live Stream</p>
                  </div>
                </div>
                ...
                <div className="absolute top-3 right-3 flex items-center gap-1 bg-black/70 backdrop-blur-sm px-2 py-1 rounded-full">
                  ...
                  <span className="text-sm font-semibold">{stream.viewers?.length || 0}</span>
                </div>

                {/* Duration */}
                <div className="absolute bottom-3 right-3 flex items-center gap-1 bg-black/70 backdrop-blur-sm px-2 py-1 rounded-full">
        ...
        {filteredStreams.length > 0 && filteredStreams.length % 20 === 0 && (
          <div className="text-center mt-8">
            <button
              ...
              className="bg-gray-800 hover:bg-gray-700 px-6 py-3 rounded-lg font-medium"
            >
              Load More
            </button>
          </div>
