...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await axios.post("https://api.theclipstream.com/api/auth/login", { email, password });
        ...
        <div className="w-full max-w-md bg-gray-900 rounded-lg p-8 shadow-xl">
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div className="flex justify-end">
              <Link
                to="/forgot-password"
                className="text-sm text-pink-500 hover:text-pink-400 font-medium transition-colors"
              >
